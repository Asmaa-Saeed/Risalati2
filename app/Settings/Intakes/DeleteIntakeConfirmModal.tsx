...
export default function DeleteIntakeConfirmModal({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
  intakeName,
}: DeleteIntakeConfirmModalProps) {
  return (
                  ...
                  <div className="mt-3 text-center sm:mr-4 sm:mt-0 sm:text-right">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        هل أنت متأكد من رغبتك في حذف العام الدراسي <span className="font-medium">{intakeName}</span>؟
                        سيتم حذف جميع البيانات المرتبطة بهذا العام الدراسي ولا يمكن التراجع عن هذا الإجراء.
                      </p>
                    </div>
                  </div>
                </div>
